...
load_path = '../TwoTimeScale_data/exmp1/' 
j = 0
n_ite = 1000000
s_plot = 100
s_slope = 100000
...
for alpha in alpha_list:
    for beta in beta_list:
        ...
        plt.text(1.2e4, 1.5e-3, 'slope of x: ' + str(round(slope_x, 2)))
        plt.text(1.2e4, 5e-4, 'slope of y: ' + str(round(slope_y, 2)))
    ...
    plt.savefig('./figs/exmp1_4.pdf', bbox_inches='tight')